...
const Loans = () => {
  ...
  const { loans, deleteLoan, updateToPaid } = useLoan();
  ...
  const handleUpdateToPaid = (id) => {
    swal
      .fire({
        icon: "warning",
        title: "Do you want update to paid?",
        showCancelButton: true,
        confirmButtonText: "Yes",
      })
      .then((result) => {
                      ...
                      loans.data.map((loan, index) => (
                        <tr key={loan.id}>
                          <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            <br />
                            <Link href={"loan/" + loan.id + "/payments"}>
                              <a>
